...
var levaseRemain = 10
function ristrictedLeave(from,to){
  if(levaseRemain == 0){
...
<div class="container">
  ...
  <hr>
   ...
   <div class='container'>
	...
	<button onclick="ristrictedLeave(document.getElementsByName('fromdate')[0].value,document.getElementsByName('todate')[0].value);">calculate </button>
	<p name="msg"></p>
  <p name="days"></p>
