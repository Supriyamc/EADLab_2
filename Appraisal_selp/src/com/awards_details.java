...
@WebServlet("/awards_details")

public class awards_details extends HttpServlet { 
...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{  
			...
			record.put("Organisation_presented_By", rs.getString("Organisation_presented_By"));
			record.put("Awards_For", rs.getString("Awards_For"));
