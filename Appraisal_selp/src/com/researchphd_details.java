...
@WebServlet("/researchphd_details")

public class researchphd_details extends HttpServlet { 
...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{  
			...
			record.put("University_name", rs.getString("University_name"));
			record.put("Registration_name", rs.getString("Registration_name"));
