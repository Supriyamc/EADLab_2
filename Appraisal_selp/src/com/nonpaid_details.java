...
@WebServlet("/nonpaid_details")

public class nonpaid_details extends HttpServlet { 
...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{  
			...
			rs=stmt.executeQuery("select * from non_paid_journal where Non_Refered_Or_Refered='Refered' and Publication_Date='"+Publication_Date+"' and Faculty_Id='"+Faculty_Id+"'");
