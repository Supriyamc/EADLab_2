...
@WebServlet("/industry_details")

public class industry_details extends HttpServlet { 
...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{  
			...
			rs=stmt.executeQuery("select * from industry_relations where Date='"+Date+"' and Faculty_Id='"+Faculty_Id+"'");
			...
			record.put("Company_name", rs.getString("Company_name"));
