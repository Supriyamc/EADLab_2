...
@WebServlet("/othrservice_details")

public class othrservice_details extends HttpServlet { 
...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{  
			...
			rs=stmt.executeQuery("select * from service where Date='"+Date+"' and Faculty_Id='"+Faculty_Id+"'");
			...
			record.put("Total_service", rs.getString("Total_service"));
