...
@WebServlet("/patents_details")

public class patents_details extends HttpServlet { 
...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{  
			...
			record.put("patents_number", rs.getString("patents_number"));
			record.put("Date_of_filing", rs.getString("Date_of_filing"));
