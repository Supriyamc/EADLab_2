...
@WebServlet("/coordinator5days")

public class coordinator5days extends HttpServlet { 
...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{  
			...
			rs=stmt.executeQuery("select * from co_ordinator_organized where Hhow_Many_Days='5' and Event_Date='"+Event_Date+"' and Faculty_Id='"+Faculty_Id+"'");
