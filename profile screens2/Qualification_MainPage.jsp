...
<a class="navbar-brand hidden" href="index.html"><img src="images/msrit_logo.png" alt="Logo"></a>
...
<h1><strong>Qualification Details</strong></h1>
</div>
</div>
</div>
<div class="col-sm-8">
...
<div class="card-title">Information about Degree,college etc. </div>
</div>
<div class="card-body">
<table class="table">
...
<th scope="col">Year of Degree Awarded</th>
...
<div class="col-xl-2"><a href="Qualification_InsertPage.jsp"><button id="payment-button" type="button" class="btn btn-lg btn-info btn-block">
<i class=""></i>&nbsp;
