...
<h1>Professional Body Membership</h1>
</div>
</div>
</div>
<div class="col-sm-8">
...
<div class="form-group"><label for="company" class=" form-control-label">Name of theProfessional Body</label><input type="text" id="" placeholder="Enter here" class="form-control"></div>

<div class="form-group"><label for="vat" class=" form-control-label">Type of Membership</label><input type="text" id="" placeholder=" Enter here" class="form-control"></div>
			...
			<div class="form-group"><label for="street" class=" form-control-label">Year of Subscription</label><input type="month" id="" placeholder="Year" class="form-control"></div>
