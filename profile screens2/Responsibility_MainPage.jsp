...
<strong class="card-title">Responsibility</strong>
</div>
<div class="card-body">
<table class="table">
...
<div class="col-xl-2"><a href="Responsibility_InsertPage.jsp"><button id="payment-button" type="button" class="btn btn-lg btn-info btn-block">
<i class=""></i>&nbsp;
