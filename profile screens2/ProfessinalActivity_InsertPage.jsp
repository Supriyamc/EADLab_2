...
<div class="form-group"><label for="company" class=" form-control-label">Board</label><input type="text" id="" placeholder="Enter Board" class="form-control"></div>

<div class="form-group"><label for="vat" class=" form-control-label">College</label><input type="text" id="" placeholder=" Enter College" class="form-control"></div>
	             ...
	             <div class="col-sm-14">
	             <div class="form-group"><label for="vat" class=" form-control-label">Internal/External</label>
