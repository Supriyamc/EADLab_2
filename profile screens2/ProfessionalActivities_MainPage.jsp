...
<title>Professional Activities and Bodies</title>
...
<h1><strong>Professional Activities and Bodies</strong></h1>
</div>
</div>
</div>
<div class="col-sm-8">
...
<div class="card-title">Professional Activities </div>
</div>
<div class="card-body">
<table class="table">
...
<div class="col-xl-2"><a href="ProfessinalActivity_InsertPage.jsp"><button id="payment-button" type="button" class="btn btn-lg btn-info btn-block">
<i class=""></i>&nbsp;
...
<div class="card-title">Professional Body Membership </div>
</div>
						<div class="card-body">
							<table class="table">
								<thead class="thead-dark">
									<tr>
										<th scope="col">Name of the Professional body</th>
										<th scope="col">Type of membership</th>
										<th scope="col">Year of subscription</th>
		...
		<div class="col-xl-2"><a href="ProfessionalBody_InsertPage.jsp"><button id="payment-button" type="button" class="btn btn-lg btn-info btn-block">
			<i class=""></i>&nbsp;
			<span id="payment-button-amount">INSERT</span>
