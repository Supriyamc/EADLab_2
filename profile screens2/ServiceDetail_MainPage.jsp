...
<h1><strong>Service Details</strong></h1>
</div>
</div>
</div>
<div class="col-sm-8">
...
<div class="card-title">information about services,designation etc.</div> 
</div>
<div class="card-body">
<table class="table">
...
<div class="col-xl-2"><a href="Service_InsertPage.jsp"><button id="payment-button" type="button" class="btn btn-lg btn-info btn-block">
<i class=""></i>&nbsp;
