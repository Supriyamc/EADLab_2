...
<div class="form-group"><label for="vat" class=" form-control-label">Co-ordinator</label><input type="text" id="" placeholder=" Enter Co-ordinator" class="form-control"></div>
