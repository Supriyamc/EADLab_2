...
<div class="form-group"><label for="company" class=" form-control-label">Batch</label><input type="number" id="" placeholder="Enter Batch" class="form-control"></div>
<div class="col-sm-14">
	             <div class="col-sm-14">
	             <div class="form-group"><label for="vat" class=" form-control-label">UG/PG/Phd</label>
...
<div class="form-group"><label for="vat" class=" form-control-label">Title</label><input type="text" id="" placeholder=" Enter Title" class="form-control"></div>
			...
			<div class="form-group"><label for="street" class=" form-control-label">Year</label><input type="month" id="" placeholder="To" class="form-control"></div>
