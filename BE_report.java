...
import org.bson.Document;
 ...
 @WebServlet("/jsp/BE_report")
 
public class BE_report extends HttpServlet { 
	...
	MongoCollection<Document> collection = database.getCollection("boe"); //mention the collection where you are storing the user credential details in place of "users"
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("BOE" +report_str);
