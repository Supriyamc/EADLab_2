...
<title>Awards Insert Page</title>
	...
	<div class="content">
		<div class="animated fadeIn">
			<div class="row">
				<div class="col-lg-8">
					<div class="card">
						<div class="card-header"><index>INSERT</index></div>
					
						<div class="card-body card-block">
						
						<div class="form-group">
							<label for="company" class=" form-control-label">Presented By</label>
							<input type="text" id="" placeholder="Presented By" class="form-control">
						</div>
						
						
							
						<div class="form-group">
							<label for="company" class=" form-control-label">Awarded For</label>
							<input type="text" id="" placeholder="Enter Awarded For" class="form-control">
						</div>
