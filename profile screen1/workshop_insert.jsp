...
<title>Workshop FDPs Insert Page</title>
				...
				<div class="col-lg-8">
					<div class="card">
						...
						<div class="form-group">
							...
							<input type="text" id="" placeholder="Enter Type" class="form-control">
						</div>
						...
						<div class="col-sm-14">
				             <div class="form-group">
				             	<label for="vat" class=" form-control-label">Sponsored/Funded</label>
						...
						<div class="form-group">
							...
							<input type="month" id="" placeholder="To" class="form-control">
						</div>
						
						
						<div class="form-group">
							<label for="vat" class=" form-control-label">Place</label>
							<input type="text" id="" placeholder=" Enter Place" class="form-control">
						</div>
						
						<div class="col-sm-14">
				             <div class="form-group">
				             	<label for="vat" class=" form-control-label">Duration</label>
								<select id=select1" class="form-control"/>
