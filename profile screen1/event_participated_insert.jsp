...
<title>Event Participated Insert Page</title>
				...
				<div class="col-lg-8">
					<div class="card">
						...
						<div class="form-group">
							...
							<input type="text" id="" placeholder="Enter Event Name" class="form-control">
						</div>
						...
						<div class="col-sm-14">
				             <div class="form-group">
				             	<label for="vat" class=" form-control-label">Outside/Inside</label>
