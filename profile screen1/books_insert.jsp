...
<title>Books Deatils Insert</title>
						...
						<div class="card">
							<div class="card-header"><index>INSERT</index><small> DATA</small></div>
								...
								<div class="card-body card-block">
										...
										<div class="form-group"><label for="company" class=" form-control-label">Books Title</label><input type="text" id="" placeholder="Enter Book Name" class="form-control"></div>
								
										<div class="form-group"><label for="vat" class=" form-control-label">Author1</label><input type="text" id="" placeholder=" Enter Author Name" class="form-control"></div>
										<div class="form-group"><label for="vat" class=" form-control-label">Author1</label><input type="text" id="" placeholder=" Enter Author Name" class="form-control"></div>
										<div class="form-group"><label for="vat" class=" form-control-label">Author1</label><input type="text" id="" placeholder=" Enter Author Name" class="form-control"></div>
									
										
										<div class="form-group"><label for="street" class=" form-control-label">Publisher</label><input type="text" id="" placeholder="Enter Publisher" class="form-control"></div>
								
										<div class="form-group"><label for="data" class=" form-control-label">ISBN</label><input type="text" id="" placeholder="Enter ISBN" class="form-control"></div>
								
								
										<div class="row form-group">
											<div class="col-8">
												<div class="form-group">
													<label for="city" class=" form-control-label">Year</label>
