...
import org.bson.Document;
 ...
 @WebServlet("/jsp/BS_report")
 
public class BS_report extends HttpServlet { 
	...
	MongoCollection<Document> collection = database.getCollection("bos"); //mention the collection where you are storing the user credential details in place of "users"
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("BOS " +report_str);
