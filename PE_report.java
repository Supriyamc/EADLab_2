...
import org.bson.Document;
 ...
 @WebServlet("/jsp/PE_report")
 
public class PE_report extends HttpServlet { 
	...
	MongoCollection<Document> collection = database.getCollection("project_examinations"); //mention the collection where you are storing the user credential details in place of "users"
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String user_name = request.getParameter("user_name");
		System.out.println("Username  SS= " +user_name);
		...
		//Document myDoc =  collection.find(regex("subject_code1", "SP_")).first();
		...
		System.out.println("Project Examinations" +report_str);
