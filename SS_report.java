...
import org.bson.Document;
 ...
 @WebServlet("/jsp/SS_report")
 
public class SS_report extends HttpServlet { 
	...
	MongoCollection<Document> collection = database.getCollection("scheme_solution"); //mention the collection where you are storing the user credential details in place of "users"
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Scheme And Solution" +report_str);
