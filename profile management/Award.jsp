...
<head>
  ...
  <title>Awards Details Entry</title>
	...
	<div class="row"><br><br><br><br><br><br><br><br>
		...
		<div class="col-sm-4" style="background-image: linear-gradient();">
			...
			<div class="row">
				...
				<div class="col-sm-12">
				<input type="text" class="form-control" placeholder="Organisation presented by" />
				</div>
			</div></br>
			<div class="row">
				
				<div class="col-sm-12">
				<input type="text" class="form-control" placeholder="Awarded for" />
				</div>
			</div></br>
			<div class="row">
