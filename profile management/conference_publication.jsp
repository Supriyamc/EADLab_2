...
<head>
  ...
  <title>Conference publications Details Entry</title>
	...
	<div class="row"><br><br><br><br>
		...
		<div class="col-sm-4" style="background-image: linear-gradient();">
			...
			<div class="row">
				...
				<div class="col-sm-12">
				<input type="text" class="form-control" placeholder="Conference name" />
				</div>
			</div></br>
			<div class="row">
				
				<div class="col-sm-12">
				<input type="text" class="form-control" placeholder="Conference type" />
				</div>
			</div></br>
			<div class="row">
				
				<div class="col-sm-12">
				<input type="text" class="form-control" placeholder="Organised by" />
				</div>
			</div></br>
			<div class="row">
